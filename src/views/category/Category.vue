<template>
  <div class="category">
    ...
    <scroll class="scroll-height">
      ...
      <goods-list-category :goods="categoryDetailList" :goods-height="false" />
    </scroll>
  </div>
</template>
...
import GoodsListCategory from "@/components/content/goods_category/GoodsListCategory";
...
export default {
  ...
  components: { GoodsListCategory, TabControl, Scroll, Subcategory, NavBar, SlideBar },
  methods: {
